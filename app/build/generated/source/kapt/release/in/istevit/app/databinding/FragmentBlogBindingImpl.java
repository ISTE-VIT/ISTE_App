...
public class FragmentBlogBindingImpl extends FragmentBlogBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.chip_all, 3);
        sViewsWithIds.put(R.id.chip_recents, 4);
    ...
    public FragmentBlogBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentBlogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
